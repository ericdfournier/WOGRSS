function [ outputShapeStruct ] = extractVectorDataFnc( ...
                                                    inputShapeStruct,...
                                                    hucCodeShapeStruct, ...
                                                    hucIndex, ...
                                                    gridMaskGeoRasterRef )
% extractVectorDataFnc.m Function to generate the intersection of an input
% vector dataset (corresponding to the gridMask basin outline) and some
% inputShapeStruct vector dataset. 
% 
...
% SYNTAX:
%
%   [ outputShapeStruct ] = extractVectorDataFnc( ...
%                                               inputShapeStruct, ...
%                                               hucCodeShapeStruct, ...
%                                               hucIndex, ...
%                                               gridMaskGeoRasterRef )
