...
%
%   rasterNanFloors =   [r x 1] array indicating the floors for all real
...
%                       supplied that value will be, by default, applied to
%                       all of the raster datasets encountered. 
%
...
parse(P,nargin,nargout,topLevelRasterDir,rasterNanFloors,gridMask, ...
    gridMaskGeoRasterRef);
...
for i = 1:subDirCount
    ...
    rasterMosaicCell{i,1} = rasterMosaicList2DataFnc(rasterMosaicList,...
        rasterNanFloors,gridMask,gridMaskGeoRasterRef);
