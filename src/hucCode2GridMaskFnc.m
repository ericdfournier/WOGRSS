function [ gridMask, spatialRef ] = hucCode2GridMaskFnc( ...
                                                hucCodeShapeStruct, ...
                                                hucIndex, ...
                                                gridDensity )
...
% SYNTAX:
%
%   [ gridMask, spatialRef ] =  hucCode2GridMaskFnc( ...
%                                               hucCodeShapeStruct, ...
%                                               hucIndex, ...
%                                               gridDensity);
%
...
[gridMask, spatialRef] = vec2mtx(basinLat,basinLon,gridDensity,'filled');
gridMask(gridMask <= 1) = 1;
gridMask(gridMask == 2) = 0;
gridMask = gridMask(2:end-1,2:end-1);
