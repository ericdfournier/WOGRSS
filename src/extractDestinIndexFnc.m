function [ destinIndex ] = extractDestinIndexFnc( ...
                                                gridMaskGeoRasterRef, ...
                                                gridMask )
% extractDestinIndexFnc.m Function which prompts the user to manually 
% select the location of the destination index which will be used to 
% initiate the MOGADOR corridor location procedure
%
% DESCRIPTION:
%
...
% SYNTAX:
%
%   [ destinIndex ] =  extractDestinIndexFnc(   gridMaskGeoRasterRef, ...
%                                               gridMask );
%
% INPUTS: 
%
